...
<body style="font-family: Arial, sans-serif; background-color: #ffffff; margin: 0; padding: 0;">
    <div style="max-width: 700px; margin: 0 auto; padding: 30px; border: 1px solid #e0e0e0;">
        ...
        <p style="font-size: 16px;">
            Please begin the <strong>Pre-Arrival process and reconfirm the </strong> for the Member,
            as quickly and accurately as possible. Their arrival is <strong>7 days</strong> away.
        </p>
