                 ...
                 <div id="unverified-content">
                     <div class="text-center mb-3">
                        ...
                        <div id="additional-info" style="display: none;">
                            ...
                            <p class="mb-0">
                                <strong>Proof of Address requirement:</strong> Only utility bills from the last 3 months or bank statements are accepted.
                            </p>
                        </div>
                     ...
                     <form id="verification-form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="passport_image">Passport <span class="text-danger" id="passport-required">*</span></label>
                            ...
                            <div class="form-group" id="passport-pdf-preview-container" style="display: none;">
                                <label>Passport Preview:</label>
                                <div class="text-center">
                                    <iframe id="passport-pdf-preview" width="100%" height="500" style="border: 1px solid #ccc; border-radius: 5px;">
                                    </iframe>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="proof_of_address">Proof of Address <span class="text-danger" id="address-required">*</span></label>
                            ...
                            <div id="address-upload-section">
                                ...
                                <small class="form-text text-info d-block mt-1">
                                    <i class="fa fa-info-circle"></i> <strong>Accepted documents:</strong> Utility bill from the last 3 months or bank statement
                                </small>
                            </div>
                            ...
                            <div class="form-group" id="address-pdf-preview-container" style="display: none;">
                                <label>Proof of Address Preview:</label>
                                <div class="text-center">
                                    <iframe id="address-pdf-preview" width="100%" height="500" style="border: 1px solid #ccc; border-radius: 5px;">
                                    </iframe>
                                </div>
                            </div>
                        </div>
